            ...
            (i.collisions = function (e, t) {
                for (var n = [], s = t.pairs.table, l = 0; l < e.length; l++) {
                    ...
                    if (
                        ...
                        for (
                            var d = c.parts.length > 1 ? 1 : 0;
                            d < c.parts.length;
                            d++
                        )
                            for (
                                var p = c.parts[d],
                                    f = u.parts.length > 1 ? 1 : 0;
                                f < u.parts.length;
                                f++
                            ) {
                                var v = u.parts[f];
        ...
        function (e, t, n) {
            ...
            (i.collides = function (e, t, n) {
                ...
                if (n && u) {
                    ...
                    if (
                        (a = i._overlapAxes(e.vertices, t.vertices, e.axes))
                            .overlap <= 0
                    )
                        return (c.collided = !1), c;
                    if (
                        (s = i._overlapAxes(t.vertices, e.vertices, t.axes))
                            .overlap <= 0
                    )
                        return (c.collided = !1), c;
                    a.overlap < s.overlap
                ...
                'undefined' != typeof window &&
                    ...
                    (i.world = function (e, t) {
                        ...
                        !y.wireframes || (d.enableSleeping && y.showSleeping)
                            ...
                            y.showSeparations &&
                                i.separations(e, d.pairs.list, m),
                            y.showCollisions &&
                                i.collisions(e, d.pairs.list, m),
                            y.showVertexNumbers && i.vertexNumbers(e, S, m),
                            y.showMousePosition &&
                                i.mousePosition(e, e.mouse, m),
                            i.constraints(w, m),
                ...
                (i.update = function (e, t, n) {
                    ...
                    for (
                        s.update(A, w, P),
                            s.removeOld(A, P),
                            e.enableSleeping &&
                                o.afterCollisions(A.list, g.timeScale),
                            A.collisionStart.length > 0 &&
                                c.trigger(e, 'collisionStart', {
                    ...
                    return (
                        A.collisionActive.length > 0 &&
                            c.trigger(e, 'collisionActive', {
                                pairs: A.collisionActive,
                            }),
                        A.collisionEnd.length > 0 &&
                            c.trigger(e, 'collisionEnd', {
            ...
            (i._restingThresh = 4),
                ...
                (i.postSolvePosition = function (e) {
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (
                            ((n.totalContacts = 0),
                            0 !== n.positionImpulse.x ||
                                0 !== n.positionImpulse.y)
                        ) {
                    ...
                    for (
                        ...
                        if (f.isActive && !f.isSensor) {
                            ...
                            (m.velocity.x = m.position.x - m.positionPrev.x),
                                (m.velocity.y =
                                    m.position.y - m.positionPrev.y),
                                (y.velocity.x =
                                    y.position.x - y.positionPrev.x),
                                (y.velocity.y =
                                    y.position.y - y.positionPrev.y),
                            ...
                            for (var S = 0; S < h.length; S++) {
                                ...
                                if (I * I > i._restingThreshTangent * n)
                                    w.tangentImpulse = 0;
                                else {
                                    var W = w.tangentImpulse;
                                    (w.tangentImpulse = a.clamp(
                                        w.tangentImpulse + V,
                                        -O,
                                        O
                                    )),
            ...
            (i._pairMaxIdleLife = 1e3),
                ...
                (i.removeOld = function (e, t) {
                    ...
                    for (a = 0; a < s.length; a++)
                        (o = (n = s[a]).collision).bodyA.isSleeping ||
                        o.bodyB.isSleeping
                            ? (n.timeUpdated = t)
                            : t - n.timeUpdated > i._pairMaxIdleLife &&
                              c.push(a);
